"""
Django settings for learning_djangocms project.
...
SECRET_KEY = 'django-insecure-2h59w-2+@e%*4a**jz_1vq5b^8k_x%i1na(0##8oqh7efm^o9v'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "learning_djangocms", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    BASE_DIR / "learning_djangocms" / "static",
]
